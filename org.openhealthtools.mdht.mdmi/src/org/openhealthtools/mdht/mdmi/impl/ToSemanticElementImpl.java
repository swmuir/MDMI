...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>To Semantic Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.mdht.mdmi.impl.ToSemanticElementImpl#getBusinessElement <em>Business Element</em>}</li>
 *   <li>{@link org.openhealthtools.mdht.mdmi.impl.ToSemanticElementImpl#getRule <em>Rule</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ToSemanticElementImpl extends ConversionRuleImpl implements ToSemanticElement {
	/**
	 ...
	 * @generated
	 */
	protected ToSemanticElementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MDMIPackage.Literals.TO_SEMANTIC_ELEMENT;
	}
	...
	public void setBusinessElement(MDMIBusinessElementReference newBusinessElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDMIPackage.TO_SEMANTIC_ELEMENT__BUSINESS_ELEMENT, oldBusinessElement, businessElement));
	}
	...
	public void setRule(String newRule) {
		...
		rule = newRule;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MDMIPackage.TO_SEMANTIC_ELEMENT__RULE, oldRule, rule));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MDMIPackage.TO_SEMANTIC_ELEMENT__BUSINESS_ELEMENT:
				return getBusinessElement();
			case MDMIPackage.TO_SEMANTIC_ELEMENT__RULE:
				return getRule();
		}
