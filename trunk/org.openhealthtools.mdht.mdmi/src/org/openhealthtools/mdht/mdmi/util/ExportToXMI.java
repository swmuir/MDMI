...
public class ExportToXMI {
	...
	public static void main(String[] args) {
	    ...
	    MDMIResourceImpl mdmiResourceImp = (MDMIResourceImpl) resourceSet.getResource(URI
		        .createURI(args[0]),true);
	    
	    MessageGroup messageGroup = (MessageGroup) mdmiResourceImp.getContents().get(0);
	    
	    if (mdmiResourceImp.getContents().size() > 1 && 
	    		mdmiResourceImp.getContents().get(1) instanceof MessageGroup) {
