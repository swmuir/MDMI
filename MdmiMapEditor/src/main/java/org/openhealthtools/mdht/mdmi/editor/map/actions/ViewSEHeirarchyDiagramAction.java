...
public class ViewSEHeirarchyDiagramAction extends AbstractMenuAction {
	private static final long serialVersionUID = -1;

	@Override
	public void execute(ActionEvent actionEvent) {
		viewSEHeirarchyDiagram();
	}

	public static void viewSEHeirarchyDiagram() {
		...
		if (dlg.display(frame) == BaseDialog.OK_BUTTON_OPTION) {
			...
			ViewSemanticElementHeirarchy view = new ViewSemanticElementHeirarchy(types);
